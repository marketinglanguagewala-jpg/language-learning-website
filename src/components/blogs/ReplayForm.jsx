...
export default function ReplayForm() {
  return (
    <div className="add-review-wrap">
      <div className="add-review-title text-22 fw-5 wow fadeInUp">
        Leave A Reply
      </div>
      <p className="fs-15">
      ...
      <form onSubmit={(e) => e.preventDefault()} className="form-add-review">
        <div className="cols">
          ...
          <fieldset className="tf-field" data-wow-delay="0.1s">
            <input
              className="tf-input style-1"
              id="field2"
              type="email"
